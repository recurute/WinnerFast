        ...
        <nav className="navbar bg-white rounded-b-2xl fixed top-[0.01%] shadow-md flex w-full z-30 max-sm:justify-between sm:max-xl:justify-between max-xl:flex-col sm:max-xl:px-[3%] max-sm:flex-col max-sm:px-[3%]">
            ...
            <div className={`NavbarLinks flex-grow w-full block  xl:w-auto  xl:flex xl:items-center justify-evenly max-xl:flex-col bg-rosa-200  ${isMenuOpen ? '' : 'hidden'} xl:block`}>
                    <div className="NavbarLinks_menu  max-sm:block sm:max-xl:block   w-[80%] mt-[1%] flex gap-[1.25%] xl:justify-evenly sm:max-xl:pb-[1%]">
                        ...
                        <ScrollLink onClick={()=>handlePricingClick("faqs")} to="#faqs" className=" hover:shadow-md  rounded-md Text-navbar-element block text-xl xl:inline-block xl:mt-0 text-orange-600   font-semibold max-xl:w-[100%] max-xl:border-b-2 max-xl:border-rose-100 max-sm:text-lg  max-xl:text-md max-sm:rounded-none">
                            FAQ
                        </ScrollLink>
                        <ScrollLink  onClick={()=>handlePricingClick("pricing")} to="#pricing" className="hover:shadow-md   rounded-md Text-navbar-element block text-xl xl:inline-block xl:mt-0 text-orange-600 font-semibold max-xl:w-[100%] max-xl:border-b-2 max-xl:border-rose-100 max-sm:text-lg  max-xl:text-md max-sm:rounded-none">
                            Pricing                  
                        </ScrollLink>
